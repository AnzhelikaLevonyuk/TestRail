...
public class TestCasePage extends BaseDashboardPage {
    ...
    private static final By PRIORITY_RESULT = By.cssSelector("td[data-testid ='testCaseViewCellPriorityId']");
    ...
    public void createTestCase(String title, String option, String preconditions, String steps, String expectedResult) {
        ...
        new DropDown(driver, driver.findElement(TYPE)).selectOptionByText(option);
        new DropDown(driver, driver.findElement(PRIORITY)).selectOptionByText("Critical");
    ...
    @Step("Get selected Priority option")
    public String getPriorityText() {
        return driver.findElement(PRIORITY_RESULT).getText();
    }
